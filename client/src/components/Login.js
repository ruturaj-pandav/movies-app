    ...
    <div className="h-screen">
      ...
      <div className=" flex brightness-25 loginDiv h-full bg-center bg-cover bg-no-repeat bg-[url('../../src/netflix-background.jpg')]  justify-center  ">
        <form
          ...
          className="  h-fit py-1 px-16 pt-16 pb-16 mt-3 border-2 border-r-[#E50914] border-t-[#E50914] border-l-[#E50914]  border-b-[#E50914] border-b  border-t border-r border-l rounded  "
        >
          <center>
            <img
              onClick={() => {
